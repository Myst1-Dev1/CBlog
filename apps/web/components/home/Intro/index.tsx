            ...
            return (
                ...
                >
                    ...
                    <div className="text-white flex justify-between flex-wrap gap-7 lg:gap-0 items-center w-full">
                        ...
                        <span className="w-fit px-2 py-1 bg-orange-300 rounded-full font-medium">
                            {data.category}
                        </span>
                        ...
                        <Link
                            href={`/post/${data.id}`}
                            className="grid place-items-center w-fit h-10 rounded-full px-4 bg-white text-black font-semibold transition-all hover:bg-orange-500 hover:text-white"
                        >
                            Ver Mais
                        </Link>
                        </div>
